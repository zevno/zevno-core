...
from test_framework.test_framework import ZEVNOTestFramework
...
class LLMQCoinbaseCommitmentsTest(ZEVNOTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ZEVNOTestFramework doesn't support this atm)

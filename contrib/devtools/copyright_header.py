...
Arguments:
    <base_directory> - The base directory of a ZEVNO Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The ZEVNO Core developers'
...
Arguments:
    <base_directory> - The base directory of ZEVNO Core source code repository.
"""
...
Arguments:
    <file> - A source file in the ZEVNO Core repository.
"""

...
* zevno.conf: contains configuration settings for zevnod or zevno-qt
* zevnod.pid: stores the process id of zevnod while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by zevnod or zevno-qt

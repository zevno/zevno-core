...
This document provides guidelines for internationalization of the ZEVNO Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zevno_en.ts` remains unchanged.

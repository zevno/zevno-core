...
This mechanism has been integrated into Bitcore-Node-ZEVNO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zevnopay/insight-api-zevno#web-socket-api](https://github.com/zevnopay/insight-api-zevno#web-socket-api)
* API: [https://github.com/zevnopay/insight-api-zevno#instantsend-transactions](https://github.com/zevnopay/insight-api-zevno#instantsend-transactions)

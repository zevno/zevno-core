...
#define BOOST_TEST_MODULE ZEVNO Test Suite

#include "test_zevno.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_zevno_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

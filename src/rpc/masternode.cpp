...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner ZEVNO address\n"
            "  payee          - Print the masternode payout ZEVNO address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting ZEVNO address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "zevno",               "masternode",             &masternode,             true,  {} },
    { "zevno",               "masternodelist",         &masternodelist,         true,  {} },
    { "zevno",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "zevno",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

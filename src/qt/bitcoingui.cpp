...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZEVNO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zevno: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about ZEVNO Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZEVNO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZEVNO addresses"));
    ...
    openAction->setStatusTip(tr("Open a zevno: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ZEVNO command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("ZEVNO Core"); // default title
